...
=======
>>> For Zed editor I need you to help me to write README.md file to Help people interested in it to understand my theme features and my name the auther of it
... . The theme tha
... ... t I made and upload it in GitHub named "Sky's Sea" it's consist of 12 theme flavors I will write branch theme names here, Asr, Asr+, Maghrib, Maghrib
... +, L
... ... ayl, Layl+, Fajr, Fajr+, Dhuhr+, Ghasaq+, Subh, Subh+, NOTE: the branch theme names with "+" means that this branch theme is include clear borders, a
... nd t
... ... he others is without borders. My theme branches desigened to be easy for eyes to read text and edit theme for long time and this theme design to be m
... inim
... ... alistic look makking the user focuse on the code as possible, NOTE: my 12 branch or flaveors thems the colors of the sole theme comes from sky colors
...  dur
... ... ing the day, i.e. Asr means Afternoon, Subh means Moring .. ect
... 
Thinking...
We need to write a README.md for a theme "Sky's Sea" with 12 flavors, describing features, author name, instructions, maybe installation, screenshots, 
...
|---------------------------|
| **12 Distinct Flavors**     One for each major time‑of‑day segment (Asr, Maghrib, Layl, Fajr, Dhuhr, Ghasaq, Subh) plus “+” variants with clear borders.|
| **Sky‑Inspired Palette**  | Colors are taken directly from real sky hues (dawn, midday, dusk, night). 
| **Minimalistic Design**   | Low contrast UI chrome lets the code itself become the visual focus. 
| **Eye‑Friendly**          | Soft contrast ratios reduce strain during prolonged use. 
| **Border Variants (`+`)   | Flavors suffixed with `+` add thin, distinct borders around pans, tabs, and the status bar for those who prefer extra 
visual separation.          |
